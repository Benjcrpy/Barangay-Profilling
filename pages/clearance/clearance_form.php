        ...
        <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    <div class="center" style="font-size: 16px;"><b>
                        Republic of the Philippines<br>
                        Manila City<br>
                        Metro Manila <br>
                        BARANGAY 564 Zone 55<br>
                        Tel. 111-0000<br></b>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <p style="text-indent:40px;text-align: justify;">This is to certify that the person whose photo, signature and right thumb mark appear herein, is a resident of Barangay 564 Zone 55, Manila City and that the person had requested a criminal check from this office following is/are our findings.</p>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_array($qry)){
                                ...
                                <p><b>
                                    ...
                                    ISSUED AT: <u>BARANGAY 564 OFFICE</u><br>
